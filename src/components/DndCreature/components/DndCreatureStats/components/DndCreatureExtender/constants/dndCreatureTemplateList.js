  ...
  },
  {
    ...
    extendPropCollection: {
      ...
      featureList: [
        {
          name: 'Паучье лазание',
          description: `Рой может лазать по сложным поверхностям, включая потолки, без совершения проверок характеристик.`,
        },
        {
          name: 'Чувство паутины',
          description: `Находясь в контакте с паутиной, рой знает точное местоположение всех других существ, находящихся в контакте с той же паутиной.`,
        },
        {
          name: 'Хождение по паутине',
          description: `Рой игнорирует ограничения перемещения, вызванные паутиной.`,
        },
      ],
    },
  },
