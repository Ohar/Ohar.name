...
**Дурная порода.** Карги любят украшать себя чемто мёртвым, подчёркивая внешность костьми, кусками плоти и грязью. Они специально теребят раны и не сводят пятна с кожи, превращая их в гноящуюся плоть. Красивые существа вызывают у карг отвращение, но они могут им «помочь», изменив их тело.\n
...
В жилах многих существ, включая [виверн](CREATURE:wyvern) и [дракочерепах](CREATURE:dragon_turtle), течёт драконья кровь. Истинные же драконы делятся на две крупных группы — цветных и металлических драконов. [Белые](CREATURE:ancient_white_dragon), [зелёные](CREATURE:ancient_green_dragon), [красные](CREATURE:ancient_red_dragon), [синие](CREATURE:ancient_blue_dragon) и [чёрные](CREATURE:ancient_black_dragon) драконы эгоистичны, злы, и их боятся. [Бронзовые](CREATURE:ancient_bronze_dragon), [золотые](CREATURE:ancient_gold_dragon), [латунные](CREATURE:ancient_brass_dragon), [медные](CREATURE:ancient_copper_dragon) и [серебряные](CREATURE:ancient_silver_dragon) драконы благородны, добры, и их уважают за мудрость.\n
...
const colorDragonDescriptionList = [
  {
    ...
    text: `[Белые](CREATURE:ancient_white_dragon), [зелёные](CREATURE:ancient_green_dragon), [красные](CREATURE:ancient_red_dragon), [синие](CREATURE:ancient_blue_dragon) и [чёрные](CREATURE:ancient_black_dragon) драконы представляют злую сторону драконьего рода. Агрессивные, ненасытные и тщеславные, цветные драконы являются тёмными гениями и могучими тиранами, которых боятся другие существа, да и друг друга они тоже боятся.\n
...
**Безумные рабы.** Во время расцвета империи иллитидов, свежеватели разума захватывали куо-тоа тысячами и обращали их в рабство. Куо-тоа были простыми существами, не способными противостоять психической силе иллитидов. К тому времени, когда иллитиды покинули их, длительное нахождение куо-тоа в психическом подчинении свело их с ума.\n
...
Куо-тоа, чьи пути пересекались с [аболетами](CREATURE:aboleth), зачастую поклоняются им как богам. Ослеплённые безумием, они не понимают, что аболеты используют их для своих гнусных целей.\n
**Теократические правители.** Первосвященники куо-тоа окружены фанатично настроенными приверженцами их веры. Первосвященник домена куо-тоа требует, чтобы все поданные поклонялись определённому божеству. Безумная вера первосвященника в собственного бога столь пылкая, что наделяет его полномочиями [верховного жреца](CREATURE:kuo_toa_archpriest). Первосвященник может также обучать заклинаниям набожных подчинённых, называемых [кнутами](CREATURE:kuo_toa_whip). Один или несколько этих кнутов являются детьми первосвященника, их основная роль в обществе куо-тоа — бороться насмерть за право воссесть на трон, когда первосвященник умрёт. Если кнут разгневает первосвященника, первосвященник может лишить его способностей заклинателя, если не жизни.\n
Приказы первосвященника воплощаются [надзирателями](CREATURE:kuo_toa_monitor), набожными куо-тоа, действующими как его глаза и уши. Надзиратели — смертоносные рукопашные воители, и меньшие [куо-тоа]](CREATURE:kuo_toa) живут в страхе перед ними.\n
...
**Гоблиноиды.** Медвежатников часто можно встретить в компании своих близких родственников, [хобгоблинов](CREATURE:hobgoblin) и [гоблинов](CREATURE:goblin). Обычно медвежатники порабощают гоблинов, с которыми столкнулись, а хобгоблинов они запугивают, суля им золото и пищу в обмен на работу в качестве разведчиков и ударных войск. Даже платящие медвежатники — не самые надёжные союзники, но гоблины и хобгоблины понимают, что как бы медвежатники не истощали ресурсы племени, они остаются могучей силой.\n
...
**Рождённые смертью.** Большинство жертв вампира становятся [порождениями вампира](CREATURE:vampire_spawn) — хищными созданиями с вампирским голодом к крови, но находящимися под контролем вампира, который их создал. Если истинный вампир позволит порождению выпить кровь из своего тела, порождение превратится в истинного вампира, не подконтрольного своему хозяину. Немногие вампиры готовы отказаться от этого влияния. Порождение вампира обретает собственную волю, когда его создатель погибает.\n
...
Великаны так же стары, как и драконы, которые были ещё юными, когда первые шаги великанов сотрясли основание мира. Расселяясь на новые земли, великаны вступили в жесточайшую войну с драконами, длившуюся много поколений, что привело обе расы на грань вымирания. Ни один из живущих ныне великанов не помнит, из-за чего началась война, но мифы и легенды о славе на заре их расы всё ещё звучат в их поселениях и крепостях, клеймя позором первых вирмов. Великаны и драконы всё ещё таят злобу друг на друга, и редко когда могут без боя находиться на одной территории. `,
  ...
  {
    header: 'Уложение',
    text: `Все основные расы великанов — [каменные](CREATURE:stone_giant), [ледяные](CREATURE:frost_giant), [облачные](CREATURE:cloud_giant), [огненные](CREATURE:fire_giant), [холмовые](CREATURE:hill_giant) и [штормовые](CREATURE:storm_giant)  — связаны общей историей, религией и культурой. Они все друг для друга родня, и при встрече отбрасывают прочь все амбиции и естественную территориальную враждебность.\n
...
Расы великанов тоже в широком смысле имеют положение в уложении. Выше всех стоят штормовые великаны, за ними следуют облачные, огненные, ледяные, каменные и потом уже холмовые великаны. Последними идут их родичи, такие как [фоморы](CREATURE:fomorian), [этты](CREATURE:ettin) и [огры](CREATURE:ogre).\n
...
**Гоблиноиды.** Гоблины принадлежат к семейству существ, называемых гоблиноидами. Их большие родственники, [хобгоблины](CREATURE:hobgoblin) и [медвежатники](CREATURE:bugbear), любят подчинять себе гоблинов путём запугивания. Гоблины ленивые и расхлябанные, что делает их плохими
...
**Лидеры и последователи.** Гоблинами правят самые сильные и умные среди них. [Гоблинский босс](CREATURE:goblin_boss) может командовать отдельным логовом, тогда как гоблинский король или королева (которые являются не более чем теми же прославленными гоблинскими боссами) управляет сотнями гоблинов, живущих во множестве логовищ, что гарантирует выживание племени. Гоблинские боссы часто меняются, а племена захватываются хобгоблинскими воеводами или вождями медвежатников.\n
...
Голем не может думать или действовать по своей воле. Несмотря на то, что он прекрасно понимает команды, он не понимает языка этих команд, и не может быть уговорён или обманут ими. Искусственная натура. Голему не нужен воздух, еда, питьё и сон. `,
}
...
const grickDescription = {
  header: 'Грик',
  text: `Похожий на червя [грик](CREATURE:grick) остаётся невидимым, сливаясь с камнями пещер и туннелей, в которых обитает. Лишь при приближении жертвы он вскакивает, а четыре его колючих щупальца открывают голодный щёлкающий клюв.\n
...
**Старшие дьяволы.** Старшие дьяволы включают [исчадий преисподних](CREATURE:pit_fiend), эриний, [рогатых дьяволов](CREATURE:horned_devil) и [ледяных дьяволов](CREATURE:ice_devil), которые руководят младшими дьяволами и служат архидьяволам.\n
**Младшие дьяволы.** Это множество видов исчадий, включая [бесов](CREATURE:imp), [дьяволов цепей](CREATURE:chain_devil), [шипастых](CREATURE:barbed_devil) и [костяных дьяволов](CREATURE:bone_devil).\n
**[Лемуры](CREATURE:lemure).** Низшая форма дьяволов — изувеченные и измученные души злых и развращённых смертных. Лемур, убитый в Девяти Преисподних, окончательно уничтожается только благословлённым оружием, или если на его бесформенный труп плеснуть святой водой.\n
...
Низкоуровневые повышения, как правило, основаны на потребности, например, когда исчадию преисподней нужны невидимые шпионы, он превращает [лемуров](CREATURE:lemure) в [бесов](CREATURE:imp).\n
Высокоуровневые повышения всегда происходят за заслуги, например, [костяной дьявол](CREATURE:bone_devil), который служит архидьяволу и отличается в бою, превращается в [рогатого дьявола](CREATURE:horned_devil). Дьяволы редко повышаются в иерархии более чем на одну ступень за раз.\n

## Иерархия ада

1. [лемур](CREATURE:lemure)

### Младшие дьяволы

2. [бес](CREATURE:imp)
3. [игольчатый дьявол](CREATURE:spined_devil)
4. [бородатый дьявол](CREATURE:bearded_devil)
5. [шипастый дьявол](CREATURE:barbed_devil)
6. [дьявол цепей](CREATURE:chain_devil)
7. [костяной дьявол](CREATURE:bone_devil)

### Старшие дьяволы

8. [рогатый дьявол](CREATURE:horned_devil)
9. [эриния](CREATURE:erinyes)
10. [ледяной дьявол](CREATURE:ice_devil)
11. [исчадие преисподней](CREATURE:pit_fiend)
...
Вне зависимости от того, как именно дьявол был призван на Материальный План, обычно он не горит желанием служить. Дьявол будет использовать каждую возможность совратить смертного призывателя, чтобы его душа в итоге попала в Девять Преисподних. Только [бесам](CREATURE:imp) нравится, когда их призывают, и они легко соглашаются служить призывателю в качестве [фамильяра](CREATURE:imp_familiar), но при этом они всё равно изо всех сил будут стараться совратить того, кто их призывает.`,
  },
]
...
**Корни древа Галтиаса.** Легенды рассказывают о [вампире](CREATURE:vampire) по имени Галтиас, которые занимался ужасной магией и воздвиг мерзкую башню, которую навали Шпиль Ночного Когтя. Галтиас был умерщвлён, когда герой проткнул ему сердце деревянным колом, но когда вампир был уничтожен, его кровь проникла в кол, наполнив его ужасной силой. Через некоторое время этот кол дал побеги и стал деревом, полным злой сущности вампира.\n
...
Мефиты эти нестареющие озорники, во множестве населяющие Стихийные Планы и Стихийный Хаос. Они также нередко находят пути на Материальный План, где предпочитают обитать в местах, богатых их родными стихиями. Например, [магмовый мефит](CREATURE:magma_mephit) состоит из огня и земли, и предпочитает обитать внутри вулканов, в то время как [ледяной мефит](CREATURE:ice_mephit), состоящий из воздуха и воды, предпочитает места, где похолоднее.\n
...
module.exports.covenDescription = covenDescription
