...
const kuoToaTexts = {
  description: `Куо-тоа это выродившиеся рыбоподобные гуманоиды, которые когда то населяли побережья и острова. Давним давно люди и их род изгнали куо-тоа под землю, где те и обитают в безумии и вечной темноте. Отныне куо-тоа не переносят дневной свет.\n
...
Куо-тоа, чьи пути пересекались с аболетами, зачастую поклоняются им как богам. Ослеплённые безумием, они не понимают, что аболеты используют их для своих гнусных целей.\n
...
Приказы первосвященника воплощаются надзирателями, набожными куо-тоа, действующими как его глаза и уши. Надзиратели — смертоносные рукопашные воители, и меньшие куо-тоа живут в страхе перед ними.\n
...
const lizardfolkTexts = {
  description: `Людоящеры — примитивные рептилоидные гуманоиды, обитающие в болотах и джунглях. Их деревушки из хижин процветают в неприступных гротах, полузатонувших руинах и в залитых водою пещерах.\n
...
const bugbearsDescription = `Медвежатники рождены для битвы и хаоса. Выживая набегами и охотой, они запугивают слабых и подавляют их, но при этом они готовы сражаться на стороне сильных вождей, если это сулит им кровопролитие и сокровища.\n
...
const myconidDescription = `Микониды — это разумные, прямоходящие грибы, живущие в Подземье, ищущие просветления и порицающие насилие. Если обратиться к ним с миром, микониды с радостью предоставят укрытие и позволят безопасно пройти сквозь свою колонию.\n
...
module.exports.kuoToaFeatures = kuoToaFeatures
