...
const blueDragonDescriptionList = [
  {
    ...
    text: `Тщеславные и территориальные, синие драконы парят в небесах над пустынями, охотясь на караваны, разоряя стада и поселения в плодородных землях за границами пустыни. Эти драконы также живут в сухих степях, раскалённых пустошах и на каменистых побережьях, и ревностно охраняют свои границы от возможных соперников, особенно от [латунных драконов](CREATURE:${CREATURE_ANCIENT_BRASS_DRAGON}).\n
...
**Владыки и приспешники.** Синие драконы стараются привлечь ценных и талантливых существ, чья служба укрепит их чувство превосходства. Барды, мудрецы, художники, [волшебники](CREATURE:${CREATURE_MAGE}) и [убийцы](CREATURE:${CREATURE_ASSASSIN}) становятся ценными агентами синих драконов, которые щедро вознаграждают за верную службу.\n
...
**Последователи Хруггека.** Медвежатники поклоняются Хруггеку, малому богу, который обитает в плане Ахерон. В отсутствии их гоблиноидных родичей, медвежатники сбиваются в разношёрстные банды, каждую из которых возглавляет [сильный вождь](CREATURE:${CREATURE_BUGBEAR_CHIEF}). Медвежатники верят, что когда они умирают, их души получают шанс сражаться на стороне Хруггека. Они пытаются доказать самим себе, что достойны этого, убивая как можно больше врагов.\n
...
Расы великанов тоже в широком смысле имеют положение в уложении. Выше всех стоят штормовые великаны, за ними следуют облачные, огненные, ледяные, каменные и потом уже холмовые великаны. Последними идут их родичи, такие как [фоморы](CREATURE:${CREATURE_FOMORIAN}), [этты](CREATURE:${CREATURE_ETTIN}) и [огры](CREATURE:${CREATURE_OGRE}).\n
...
**Крысоводы и наездники на волках.** Гоблинов тянет к [крысам](CREATURE:${CREATURE_RAT}) и [волкам](CREATURE:${CREATURE_WOLF}), которых они взращивают своими спутниками и верховыми животными, соответственно. Подобно крысам, гоблины избегают солнечного света и днём спят под землёй. Как волки, они стайные охотники, которые становятся тем смелее, чем больше их число. Охотясь на спинах волков, они изматывают врагов, часто нападая и тут же отступая.\n
...
Чтобы создать голема, необходим _Справочник по големам_. Красочные иллюстрации и инструкции подробно объясняют процесс создания голема определённого типа.\n
...
**Порождения хаоса.** Бездна порождает демонов как продолжение самой себя, спонтанно формируя их из грязи и кровопролитий. Некоторые из них уникальны, а другие относятся к одному из видов, особи внутри которого между собой различаются очень слабо. Другие же демоны, такие как [мэйны](CREATURE:${CREATURE_MANES}), создаются из душ смертных, отверженных или проклятых богами, или иным образом заточённых в Бездне.\n
...
**Гоблиноиды.** Хобгоблины принадлежат к семейству существ, называемых гоблиноидами. Зачастую они командуют другими существами своего семейства, например, [гоблинами](CREATURE:${CREATURE_GOBLIN}) или свирепыми [медвежатниками](CREATURE:${CREATURE_BUGBEAR}).\n
**Боевая мощь.** Хобгоблин измеряет добродетель физической силой и военной доблестью, не заботясь ни о чём, кроме возможности продемонстрировать навык и хитрость в битве. Хобгоблин высшего военного ранга добивается своих позиций силой, а затем удерживает эти позиции, навязывая свой авторитет драконовскими мерами.\n
...
**Завоевание и контроль.** Хобгоблины претендуют на земли, изобилующие ресурсами, и их можно найти в лесах и горах, вблизи шахт и поселений гуманоидов и где угодно ещё, где можно найти древесину, металл и потенциальных рабов. Они строят и завоёвывают крепости в стратегически выгодных местах, которые они потом используют как плацдарм для расширения своей территории.\n
...
**Беспощадные политики.** Политика дроу беспощадна и кишит интригами. Обычно дроу работают вместе, чтобы уничтожить общего врага или обеспечить собственное выживание. Такие союзы длятся недолго и таят в себе опасность.\n
...
**Правила матриархата.** Лолс, через своих верных [жриц](CREATURE:${CREATURE_DROW_PRIESTESS_OF_LOLTH}), диктует правила обществу дроу, передаёт приказы и осуществляет заговоры. Поскольку Лолс часто появляется на Материальном Плане и напрямую наказывает тех, кто не повинуются ей, дроу научились прислушиваться к её словам и действиям, как и к приказам жриц.\n
...
**Склонность к ядам.** Дистиллированный яд пауков и растительности Подземья часто встречается среди дроу и играет большую роль в их культуре и политике. Маги дроу придумали вязкий токсин, лишающий врагов сознания. [Воины дроу](CREATURE:${CREATURE_DROW_ELITE_WARRIOR}) покрывают свои клинки и арбалетные болты этим ядом, рассчитывая после боя на допрос или пытки. `,
}

const drowNote = {
  text: `Такая порочность. Такая ужасающая жестокость. Они — мерзкий яд, отравляющий всех эльфов`,
  author: `Нэлар Отэмвэлл, эльфийский жрец Кореллона Ларетиана`,
}

const yuantiDescription = [
  {
    header: 'Юань-ти',
...
**Фальшивое поклонение.** Жизни юань-ти вращается вокруг их храмов, однако юань-ти не любят богов, которым они поклоняются. Вместо этого они рассматривают поклонение как способ достижения силы. Юань-ти верят, что индивид, у которого окажется достаточно силы, сможет поглотить и заменить одного из богов юань-ти. Юань-ти стремятся к вознесению, и готовы совершить самые ужасные злодейства, чтобы его достичь.`,
  ...
  {
    header: 'Змеиные боги',
    text: `Юань-ти почитают ряд могущественных сущностей как богов, в том числе следующих:\n
...
module.exports.drowDescription = drowDescription
module.exports.drowNote = drowNote
module.exports.elementalDescription = elementalDescription
module.exports.geniusDescription = geniusDescription
module.exports.ghoulDescription = ghoulDescription
...
module.exports.hobgoblinDescription = hobgoblinDescription
module.exports.hobgoblinNote = hobgoblinNote
...
module.exports.yuantiNote = yuantiNote
module.exports.yugolothDescription = yugolothDescription
