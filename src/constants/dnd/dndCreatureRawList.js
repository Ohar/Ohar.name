const {
  ...
  } = require('./dndCreatureCommonParts'),
  {
    ...
    CREATURE_PSEUDODRAGON_FAMILIAR,
    CREATURE_PTERANODON,
...
**Бесконечная война.** Гримлоки всё ещё чтят свежевателей разума, служа им там, где это возможно. И они всё ещё помнят войну, что загнала их глубоко под землю. Для них она никогда не закончится. Они продолжают возвращаться на поверхность, похищая пленников для своих хозяев иллитидов. `,
  ...
  },
  {
    ...
    nameEn: 'Griffon',
    id: CREATURE_GRIFFON,
    description: `Грифоны — свирепые крылатые хищники с мускулистыми телами львов и головами, передними лапами и крыльями орлов. Когда они нападают, грифоны смертоносны и быстры, как [орлы](CREATURE:${CREATURE_EAGLE}), несмотря на то, что удары их мощны и грациозны, как у [львов](CREATURE:${CREATURE_LION}).\n
**Пожиратели лошадей.** Грифоны охотятся небольшими прайдами, летая над равнинами и лесами близ своих скал. Стадные животные и [лошади](CREATURE:${CREATURE_RIDING_HORSE}) — их любимая пища, однако они также охотятся и на [гиппогрифов](CREATURE:${CREATURE_HIPPOGRIFF}). Заметив лошадей, грифон кричит, чтобы предупредить своих гордых собратьев, которые мгновенно набрасываются на жертву.\n
...
**Натура нежити.** Демиличу не нужен воздух, еда, питьё и сон. Желание выжить у демилича столь сильно, что у него всегда максимальное количество хитов на Костях Хитов вместо средних. `,
    ...
    legendaryActionList: [
      ...
      },
      {
        ...
        cost: 3,
        description: `Демилич нацеливается на одно существо, которое видит в пределах 30 футов от себя. Цель должна преуспеть в спасброске Мудрости со Сл 15, иначе она станет магическим образом проклятой. Пока проклятье действует, цель совершает с помехой броски атаки и спасброски. Цель может повторять этот спасбросок в конце каждого своего хода, оканчивая проклятье при успехе.`,
      },
    ],
  },
  {
...
При любой возможности огры стараются объеиняться с другими чудовищами, чтобы запугивать и охотиться на существ слабее, чем они сами. Они часто сотрудничают с [гоблиноидами](CREATURE:${CREATURE_GOBLIN}), [орками](CREATURE:${CREATURE_ORC}) и [троллями](CREATURE:${CREATURE_TROLL}), и практически боготворят великанов. В комплексной социальной структуре великанов (известной как «положение») огры по статусу находятся под самыми нижайшими великанами. В результате огры делают практически всё, что говорят им великаны. `,
    note: {
...
**Слуги тьмы.** Не имеющие доверия среди орков, некоторые ороги образуют отряды наёмников, которые продают свои услуги тому, кто заплатит больше остальных. До тех пор, пока им платят, наёмники ороги служат элитными воинами и ударными отрядами для злых колдунов, порочных великанов и других злодеев. `,
    ...
    featureList: [
      {
        name: 'Агрессивный',
        description: `Орог может бонусным действием переместиться на расстояние, не превышающее его скорость, в сторону видимого враждебного существа.`,
      },
    ],
    actionList: [
      {
        name: 'Мультиатака',
        description: `Орог совершает две атаки секирой.`,
      },
      {
        name: 'Секира',
        attack: {
  ...
  },
  {
    ...
    nameEn: 'Otyugh',
    id: CREATURE_OTYUGH,
    description: `Отидж — это гротескное существо с луковицеобразным телом на трёх крепких ногах, глаза и нос которого расположены на стебле, растущем из верхней части раздутого тела. Два упругих щупальца заканчиваются остроконечными листовидными придатками, которыми отидж загребает пищу в разинутую пасть.\n
...
**Симбиотические охранники.** Разумные обитающие под землёй существа сосуществуют с отиджами, используя их как утилизаторов мусора. На таком обильном питании отиджи жиреют в своих лежбищах, более не движимые другими желаниями и мотивами. Эта неподвижная прожорливость делает их надёжными охранниками. До тех пор, пока он накормлен, отидж воздерживается от нападения на других существ. Тем не менее, потенциальный хозяин отиджа может недооценить потребное количество отходов, падали и мяса, чтобы удержать его от блужданий в поисках еды. Немало хозяев было сожрано «тренированными» отиджами после того, как пища заканчивалась в его лежбище.`,
    ...
    featureList: [
      {
        name: 'Ограниченная телепатия',
        description: `Отидж может магическим образом передавать простые послания и образы любому существу в пределах 120 футов, понимающему любой язык. Эта телепатия не позволяет существу давать телепатический ответ.`,
      },
    ],
    actionList: [
      {
        name: 'Мультиатака',
        description: `Отидж совершает три атаки: одну укусом, и две щупальцами.`,
      },
      {
        name: 'Укус',
      ...
      {
        name: 'Щупальце',
        description: `Если размер цели не больше Среднего, она становится схваченной (Сл высвобождения 13) и опутанной, пока не перестанет быть схваченной. У отиджа есть два щупальца, и каждое может схватить по одной цели.`,
        attack: {
          type: ACTION_MELEE_WEAPON_ATTACK,
          bonus: 6,
          range: 10,
      ...
      {
        name: 'Удар щупальцем',
        description: `Отидж ударяет схваченных существ друг о друга или о твёрдую поверхность. Каждое существо должно преуспеть в спасброске Телосложения со Сл 14, иначе получит дробящий урон 10 (2к6+3) и станет ошеломлённым до конца следующего хода отиджа. При успешном спасброске существо получает половину дробящего урона и не становится ошеломлённым.`,
      },
    ],
  },
  {
    ...
    nameEn: 'Bulette',
    id: CREATURE_BULETTE,
    description: `Панцирница — это огромный хищник, терроризирующий земли, в которых он обитает. Её также называют «земляной акулой», и её единственная цель — питаться. Раздражительные и хищные, панцирницы не боятся других существ, и нападают, не обращая внимания на численное преимущество и силу противника.\n
...
**Магические создания.** Некоторые мудрецы считают, что панцирницы это результат эксперимента безумных магов по скрещиванию черепахи и броненосца с помощью инъекций ихора демона. Некоторое время панцирниц считали вымершими, но через несколько лет они снова появились. Так как молодняк панцирниц никто не видел, некоторые мудрецы полагают, что существуют тайные гнёзда, откуда взрослые особи выходят в мир. `,
    ...
    featureList: [
      {
        name: 'Прыжок с места',
        description: `Панцирница совершает прыжки в длину на расстояние до 30 футов и прыжки в высоту на расстояние до 15 футов, хоть с разбегом, хоть без него.`,
      },
    ],
    actionList: [
      {
  ...
  },
  {
    ...
    nameEn: 'Pegasus',
    id: CREATURE_PEGASUS,
    description: `Белокрылые пегасы парят в небесах прообразом грации и величия. Они спускаются на землю лишь на мгновения, чтобы утолить жажду из горных ручьев и девственно чистых озёр. Любой звук или присутствие другого существа пугает их, и они взмывают обратно в облака.\n
**Благородные ездовые животные.** Пегасы высоко ценятся за скорость и надёжность, будучи более быстрыми и менее темпераментными, чем [грифоны](CREATURE:${CREATURE_GRIFFON}), [гиппогрифы](CREATURE:${CREATURE_HIPPOGRIFF}) и [виверны](CREATURE:${CREATURE_WYVERN}). Тем не менее, эти дикие и пугливые создания умны как гуманоиды, и не могут быть объезжены и приручены традиционным способом. Пегаса нужно убедить служить ездовым животным для существа с добрым мировоззрением, и когда это случается, между ним и его новым товарищем образуется связь на всю жизнь.\n
**Рождённые на планах.** Происхождение пегасов уходит корнями в Олимпийские просторы Арбореи, где они парили в небесах этого плана и служили верными ездовыми животными для Селдарин, пантеона эльфийских божеств. Известно, что эти божества посылали пегасов в Материальный План для помощи тем, кто нуждается.\n
**Гнездовья пегасов.** Пегасы образуют пары на всю жизнь, строят гнезда в труднодосягаемых местах и рожают там молодняк. `,
  ...
  },
  {
    ...
    nameEn: 'Peryton',
    id: CREATURE_PERYTON,
    description: `Хотя это плотоядное чудовище может питаться любыми существами, оно предпочитает гуманоидов, особенно эльфов, полуэльфов и людей. Когда перитон убивает гуманоида, он вырывает сердце у своей жертвы и относит его в гнездо для поедания.\n
Перитон — это причудливое существо, представляющее собою смесь крыльев и тела хищной птицы с головой оленя. Странной особенностью является тень существа: она не соответствует физическому облику его тела, но выглядит как гуманоид. Мудрецы утверждают, что первыми перитонами были люди, изменённые не то отвратительным проклятьем, не то магическим экспериментом. Но барды повествуют о другой истории, о мужчине, неверность которого вынудила его жену вырезать сердце у более красивой и молодой соперницы и пожрать его в ритуале, призванном вернуть расположение мужа навсегда. Ритуал удался, но только до тех пор, пока злодеяние женщины не было раскрыто. Она была повешена за своё преступление, но магия, сохранившаяся от нечистого ритуала, превратила падальщиков, слетевшихся на её труп, в первых перитонов.\n
**Неестественный голод.** Репродуктивный цикл перитона зависит от сердца недавно убитого гуманоида. Орган должен быть поглощён самкой перитона, и только после этого она сможет размножаться. Когда сердце поглощено, тень перитона на время изменится, отобразив настоящее чудовищное тело.\n
...
Поселения привлекательны для перитонов как возобновляемый источник пищи. Это вынуждает советы поселений или местную знать нанимать искателей приключений для устранения гнездовий перитонов.`,
    ...
    featureList: [
      {
        name: `Пикирующая атака`,
        description: `Если перитон летит и пикирует как минимум на 30 футов по прямой к цели, а затем попадает по ней
рукопашной атакой оружием, атака причиняет цели дополнительный урон 9 (2к8).
Облёт. Перитон не провоцирует атаки, когда вылетает из
досягаемости врага.
Острое зрение и тонкий нюх. Перитон совершает с преимуществом проверки Мудрости (Внимательность), полагающиеся
на зрение или обоняние.`,
      },
      {
        name: `Облёт`,
        description: `Перитон не провоцирует атаки, когда вылетает из досягаемости врага.`,
      },
      {
        name: `Острое зрение и тонкий нюх`,
        description: `Перитон совершает с преимуществом проверки Мудрости (Внимательность), полагающиеся на зрение или обоняние.`,
      },
    ],
    actionList: [
      {
        name: `Мультиатака`,
        description: `Перитон совершает одну атаку боданием, и одну атаку когтём.`,
      },
      {
        name: 'Бодание',
        attack: {
...
**Противники насилия.** В отличие от их родственников, [спрайтов](CREATURE:sprite), пикси гнушаются оружия и скорее спасутся бегством, чем вступят в физическую схватку с врагом.`,
    ...
    featureList: [
      {
        name: `Сопротивление магии`,
        description: `Пикси совершает с преимуществом спасброски от заклинаний и прочих магических эффектов.`,
      },
    ],
    spellCast: {
      baseStat: PARAM_CHA,
    ...
    actionList: [
      {
        name: `Превосходная невидимость`,
        description: `Пикси магическим образом становится невидимым, пока не окончится концентрация (как при концентрации на заклинании). Всё снаряжение, которое пикси несёт или носит, становится невидимым вместе с ним.`,
      },
    ],
    isFemale: true,
  },
  {
    ...
    description: `Плащевики получили своё название за сходство с тёмными кожаными плащами. Скрываясь в дальних уголках пещер и подземелий, эти скрытные хищники поджидают одинокую или раненую добычу, неосторожно забредшую во тьму.\n
...
**Конклавы плащевиков.** Плащевики предпочитают уединение, однако иногда они собираются для защиты или обмена информацией о новых опасностях, подходящих местах для охоты или событиях, которые могут повлиять на их среду обитания. Когда конклав закончен, плащевики снова разделяются.`,
    ...
    featureList: [
      {
        name: `Передача урона`,
        description: `Пока плащевик прикреплён к существу, он получает только половину причиняемого ему урона (округляя в меньшую сторону), а оставшуюся половину получает существо.`,
      },
      {
        name: `Обманчивая внешность`,
        description: `Пока плащевик остаётся без движения, и его внутренняя сторона не видна, он неотличим от тёмного кожаного плаща.`,
      },
      {
        name: `Чувствительность к свету`,
        description: `Находясь на ярком свету, плащевик совершает с помехой броски атаки и проверки Мудрости (Внимательность), полагающиеся на зрение.`,
      },
    ],
    actionList: [
      {
        name: `Мультиатака`,
        description: `Плащевик совершает две атаки: одну укусом, и одну хвостом.`,
      },
      {
        name: `Укус`,
        description: `Если плащевик совершал бросок атаки с преимуществом, он прикрепляется к голове цели, которая становится ослеплённой, и не может дышать, пока плащевик прикреплён к ней. Пока плащевик прикреплён, он может совершать эту атаку только по цели, и бросок атаки совершает с преимуществом. Плащевик может отцепиться сам, потратив 5 футов перемещения. Любое существо, включая цель, может действием оторвать плащевика, преуспев в проверке Силы со Сл 16.`,
        attack: {
          type: ACTION_MELEE_WEAPON_ATTACK,
          bonus: 6,
          range: 5,
          ...
          hit: {
            ...
            cubeType: 6,
            cubeBonus: 3,
            comment: `, и если размер цели не больше Большого, плащевик к ней прикрепляется`,
          },
        },
      },
      {
      ...
      {
        name: `Стон`,
        description: `Все существа в пределах 60 футов от плащевика, слышащие его стон, и не являющиеся аберрациями, должны преуспеть в спасброске Мудрости со Сл 13, иначе станут испуганными до конца следующего хода плащевика. Если спасбросок существа был успешным, оно получает иммунитет к стону этого плащевика на следующие 24 часа.`,
      },
      {
        name: `Фантомы`,
        comment: `перезаряжается после короткого или продолжительного отдыха`,
        description: `Плащевик магическим образом создаёт три свои иллюзорные копии, если не находится на ярком свету. Копии перемещаются вместе с ним и подражают его действиям, постоянно перемешиваясь, чтобы невозможно было понять, кто из них настоящий плащевик. Если плащевик окажется в области яркого света, копии исчезнут.\n
...
У копий КД и спасброски как у самого плащевика. Если атака попадает по копии, или копия проваливает спасбросок от эффекта, причиняющего урон, эта копия исчезает.`,
  ...
  },
  {
    ...
    description: `Пожиратель интеллекта похож на ходячий мозг, покрытый коркой, на когтистых звериных лапах. Эта мерзкая аберрация питается интеллектом разумных существ, получая контроль над телом жертвы в угоду своим хозяевам, свежевателям разума.\n
**Создания иллитидов.** Свежеватели разума разводят пожирателей интеллекта, чтобы те служили охотниками в Подземье. Пожирателей интеллекта создают из мозга раба, подвергая его ужасному ритуалу. Мозг отращивает лапы, становясь разумным хищником, таким же извращённым и злым, как и его хозяева.\n
**Смертоносные кукловоды.** Пожиратель интеллекта поглощает разум существа и его воспоминания. Затем он обращает тело носителя в марионетку под своим контролем. Пожиратель интеллекта обычно использует свою марионетку-носителя, чтобы заманивать других во владения свежевателей разума, чтобы их поработили или съели.`,
    ...
    featureList: [
      {
        name: `Передача урона`,
        description: `Обнаружение сознания. Пожиратель интеллекта может чувствовать присутствие и местонахождение всех существ в пределах 300 футов, обладающих Интеллектом 3 и выше, какими бы барьерами они не были отгорожены, если только они не защищены заклинанием _Сокрытие разума_ (Mind blank).`,
      },
    ],
    actionList: [
      {
        name: `Мультиатака`,
        description: `Пожиратель интеллекта совершает одну атаку когтями и использует Пожирание интеллекта.`,
      },
      {
        name: `Когти`,
        attack: {
...
**Возрождающаяся угроза.** Если ползающая насыпь потерпит поражение от непреодолимого врага, корень может притвориться мёртвым, стряхивая остатки грязи. Если позже не убить корень, он врастёт в останки ползуна, медленно восстанавливая своё тело, после чего снова начнёт поглощать всё, что сможет. Таким образом, давно считавшаяся уничтоженной блуждающая насыпь будет подниматься снова и снова.`,
    sizeType: SIZE_LARGE,
    creatureTypeIdList: [
      CREATURE_TYPE_PLANT,
    ],
    ...
    featureList: [
      {
        name: `Поглощение электричества`,
        description: `Каждый раз, когда ползающая насыпь должна получить урон электричеством, она не получает урон, и вместо этого восстанавливает число хитов, равное причиняемому урону электричеством.`,
      },
    ],
    actionList: [
      {
        name: `Мультиатака`,
        description: `Ползающая насыпь совершает два размашистых удара. Если обе атаки попадают по цели с размером не больше Среднего, цель становится схваченной (Сл высвобождения 14), а ползающая насыпь использует против неё **Поглощение**.`,
      },
      {
        name: `Размашистый удар`,
        attack: {
      ...
      {
        name: `Поглощение`,
        description: `Ползающая насыпь проглатывает схваченное существо с размером не больше Среднего. Проглоченное существо опутано, ослеплено, не может дышать, и должно преуспевать в спасброске Телосложения со Сл 14 в начале каждого хода насыпи, иначе получает дробящий урон 13 (2к8+4). Если насыпь движется, проглоченная цель перемещается вместе с ней. У насыпи может быть только одно проглоченное существо одновременно.`,
      },
    ],
    isFemale: true,
  },
...
**Природа нежити.** Ползающая рука не нуждается в воздухе, еде, питье и сне.`,
    note: {
      ...
      author: `Эванжелиза Лавэйн, некромант`,
    },
    sizeType: SIZE_TINY,
    creatureTypeIdList: [
      CREATURE_TYPE_UNDEAD,
    ...
    featureList: [
      {
        name: `Иммунитет к изгнанию`,
        description: `Рука обладает иммунитетом к эффектам, изгоняющим нежить.`,
      },
    ],
    actionList: [
      {
  ...
  },
  {
    ...
    description: `Ползающие падальщики объедают гнилую плоть с трупов, а потом обгладывают оставшиеся кости. Они агрессивно атакуют любое существо, которое зашло на их территорию или беспокоит их пиршество.\n
...
При столкновении с потенциальной добычей или захватчиком, падальщик позволяет своему яду делать его работу. Как только жертву парализует, падальщик охватывает её своими щупальцами и тащит прочь к высокому выступу или изолированному проходу, где может убить её в безопасности. Затем чудовище возобновляет патрулирование своей территории, ожидая, пока его еда созреет.`,
    ...
    featureList: [
      {
        name: `Тонкий нюх`,
        description: `Ползающий падальщик совершает с преимуществом проверки Мудрости (Внимательность), полагающиеся на обоняние.`,
      },
      {
        name: `Паучье лазание`,
        description: `Ползающий падальщик может лазать по сложным поверхностям, включая потолки, без совершения проверок характеристик.`,
      },
    ],
    actionList: [
      {
        name: `Мультиатака`,
        description: `Ползающий падальщик совершает две атаки: одну щупальцами, и одну укусом.`,
      },
      {
        name: `Щупальца`,
        description: `Цель должна преуспеть в спасброске Телосложения со Сл 13, иначе станет отравленной на 1 минуту. Пока цель отравлена, она парализована. Цель может повторять этот спасбросок в конце каждого своего хода, оканчивая отравление на себе при успехе.`,
        attack: {
          type: ACTION_MELEE_WEAPON_ATTACK,
          bonus: 8,
          range: 10,
  ...
  },
  {
    ...
    nameEn: 'Ghost',
    id: CREATURE_GHOST,
    description: `Привидение это душа смертного существа, обречённая обитать в определённом месте, которое при жизни имело для него особое значение.\n
...
**Натура нежити.** Привидению не нужен воздух, еда, питьё и сон.`,
    ...
    featureList: [
      {
        name: `Эфирное зрение`,
        description: `Зрение привидения простирается на 60 футов на Эфирный План, когда оно находится на Материальном Плане, и наоборот.`,
      },
      {
        name: `Бестелесное перемещение`,
        description: `Привидение может перемещаться сквозь других существ и предметы, как если бы они были труднопроходимой местностью. Оно получает урон силовым полем 5 (1к10), если оканчивает ход внутри предмета.`,
      },
    ],
    actionList: [
      {
...
Одержимость длится до тех пор, пока хиты тела не опустятся до 0, пока привидение не окончит его бонусным действием, или пока привидение не изгонят или не заставят уйти таким эффектом как заклинание _Рассеивание добра и зла_ (Dispel evil and good). Когда одержимость заканчивается, привидение возвращается в свободное пространство в пределах 5 футов от тела. Цель получает на 24 часа иммунитет к Одержимости этого привидения после того как преуспеет в спасброске или после того как одержимость закончится.`,
  ...
  },
  {
    ...
    nameEn: 'Wraith',
    id: CREATURE_WRAITH,
    description: `Призрак — это воплощение злобы, сконцентрированное в бестелесной форме, которое стремится истребить всё живое. Это существо наполнено отрицательной энергией, и одно лишь его присутствие иссушает окружающие растения. Животные бегут от него. Даже небольшие огни тухнут, поглощённые забвением ужасного существования призрака.\n
...
**Отсутствие тела.** Призрак может перемещаться сквозь существ и твёрдые объекты так же легко, как смертное существо движется сквозь туман. Призрак может сохранить отдельные воспоминания о своей смертной жизни в виде туманных отголосков. Но даже самые важные события в жизни и самые сильные эмоции будут теперь лишь тусклым отпечатком в памяти, ускользающим как полузабытый сон. Призрак может на мгновение застыть, увидев что-то, что восхищало его при жизни, или умерить свою ярость, признав прошлую дружбу. Однако такие моменты бывают редко, потому что большинство призраков презирает былую жизнь, так как это прошлое напоминает им о том, чем они стали теперь.\n
**Командиры нежити.** Призраки могут создавать слуг-мертвецов из духов гуманоидных существ, которые недавно умерли насильственной смертью. Такой дух становится [спектром](CREATURE:specter), ненавидящим всё живое. Призраки иногда управляют легионами мертвецов, замышляя уничтожение живых существ. Когда они появляются из своих гробниц, чтобы вступить в битву, жизнь и надежда содрогаются перед ними. Даже если армия призрака вынуждена отступить, земли, которые были заняты его силами, настолько опустошены и истощены, что живущие в них зачастую могут просто умереть от голода.\n
**Натура нежити.** Призраку не нужен воздух, еда, питьё и сон.`,
    ...
    featureList: [
      {
        name: `Бестелесное перемещение`,
        description: `Призрак может перемещаться сквозь других существ и предметы, как если бы они были труднопроходимой местностью. Он получает урон силовым полем 5 (1к10), если оканчивает ход внутри предмета.`,
      },
      {
        name: `Чувствительность к солнечному свету`,
        description: `Находясь на солнечном свету, призрак совершает с помехой броски атаки, а также проверки Мудрости (Внимательность), полагающиеся на зрение.`,
      },
    ],
    actionList: [
      {
        name: `Вытягивание жизни`,
        description: `Цель должна преуспеть в спасброске Телосложения со Сл 14, иначе максимум её хитов уменьшится на количество, равное полученному урону. Это уменьшение длится до тех пор, пока цель не окончит продолжительный отдых. Цель умирает, если этот эффект уменьшает максимум её хитов до 0. `,
        attack: {
          type: ACTION_MELEE_WEAPON_ATTACK,
          bonus: 6,
          range: 5,
      ...
      },
      {
        ...
        description: `Призрак нацеливается на гуманоида в пределах 10 футов, который умер насильственной смертью не более 1 минуты назад. Дух цели восстаёт [спектром](CREATURE:specter) в пространстве трупа или ближайшем свободном пространстве. Спектр находится под контролем призрака. У призрака может быть не более семи спектров под контролем одновременно. `,
      },
    ],
  },
  {
    ...
    nameEn: 'Piercer',
    id: CREATURE_PIERCER,
    description: `Цепляясь за потолки пещер и больших подземных ходов, пронзатель прекрасно сливается со скалами, обрушиваясь в тишине на ничего не подозревающих врагов и прижимая их к земле.\n
...
Для увеличения эффективности атак пронзатели собираются в колонии и обрушиваются одновременно, чтобы более успешно поразить добычу. Как только одному из них удаётся убить существо, все остальные ползут в направлении трупа и присоединяются к пиру.`,
    ...
    featureList: [
      {
        name: `Обманчивая внешность`,
        description: `Пока пронзатель остаётся без движения на потолке, он неотличим от обычного сталактита.`,
      },
      {
        name: `Паучье лазание`,
        description: `Пронзатель может лазать по сложным поверхностям, включая потолки, без совершения проверок характеристик.`,
      },
    ],
    actionList: [
      {
        ...
        attack: {
          ...
          target: {
            count: 1,
            comment: ', находящееся точно под пронзателем',
            limit: {
              type: TARGET_CREATURE,
            },
          },
          ...
          miss: 'Пронзатель получает половину обычного урона за падение',
        },
      },
    ],
  },
  {
    ...
    description: `Неуловимый псевдодракон обитает в тихих местах, устраивая свой дом в дуплах деревьев и небольших пещерах. С чешуёй красно-коричневого цвета, рогами и пастью, полной острых зубов, псевдодракон напоминает крошечного красного дракона, но он более предрасположен к играм.\n
...
Псевдодраконы часто используют звуки животных. Хриплое мурлыканье означает удовольствие, шипение — неприятное удивление. Птичье щебетание показывает желание, а рык всегда демонстрирует гнев или неудовольствие.`,
    ...
    featureList: [
      {
        name: `Острые чувства`,
        description: `Псевдодракон совершает с преимуществом проверки Мудрости (Внимательность), полагающиеся на зрение, слух и обоняниеОстрые чувства.`,
      },
      {
        name: `Сопротивление магии`,
        description: `Псевдодракон совершает с преимуществом спасброски от заклинаний и прочих магических эффектов.`,
      },
      {
        name: `Ограниченная телепатия`,
        description: `Псевдодракон может магическим образом передавать простые мысли, эмоции и образы любому существу в пределах 100 футов, понимающему любой язык.`,
      },
    ],
    actionList: [
      {
      ...
      {
        name: `Жало`,
        description: `Цель должна преуспеть в спасброске Телосложения со Сл 11, иначе станет отравленной на 1 час. Если спасбросок провален на 5 или больше единиц, цель теряет сознание на этот же период, либо пока не получит урон, либо пока другое существо не разбудит её действием.`,
        attack: {
          type: ACTION_MELEE_WEAPON_ATTACK,
          bonus: 4,
          range: 5,
  ...
  {
    name: 'Псевдодракон-фамильяр',
    nameEn: 'Pseudodragon familiar',
    id: CREATURE_PSEUDODRAGON_FAMILIAR,
    parentId: CREATURE_PSEUDODRAGON,
    extendPropCollection: {
      description: [
        {
          header: `Вариант: Фамильяр псевдодракон`,
          text: `Некоторые псевдодраконы желают служить заклинателям в качестве фамильяра. Такие псевдодраконы обладают следующей особенностью:\n
...
**Натура конструкта. **Пугалу не нужен воздух, еда, питьё и сон.`,
  ...
  },
  {
    ...
    description: `Сверкание зелёного пламени и безумный, раскатистый смех следуют за бестелесным черепом, когда тот патрулирует свою территорию. Когда неживой пылающий череп обнаруживает вторжение, он атакует нарушителей огненными лучами из глаз и ужасными заклинаниями, вызываемыми из тёмного кладезя его памяти.\n
...
**Охваченные пламенем.** Пламя, покрывающее пылающий череп, горит постоянно, создавая яркий свет от существа. Череп контролирует пламя и может использовать его в качестве оружия — фокусируя его в лучи из своих пустых глазниц. **Жуткое возрождение.** Пылающий череп вновь собирается из разбитых кусков, если его не окропить святой водой или не подвергнуть заклинаниям _Рассеивание магии_ (Dispel magic) или снятия проклятья. Если он не может более выполнять то, для чего был создан, возрождённый пылающий череп более никому не принадлежит и действует независимо. Натура нежити. Пылающему черепу не нужен воздух, еда, питьё и сон.`,
    ...
    featureList: [
      {
        name: `Свечение`,
        description: `Пылающий череп испускает тусклый свет в радиусе 15 футов, либо яркий свет в радиусе 15 футов и тусклый свет в пределах ещё 15 футов. Он может действием переключаться между этими двумя вариантами. `,
      },
      {
        name: `Сопротивление магии`,
        description: `Пылающий череп совершает с преимуществом спасброски от заклинаний и прочих магических эффектов.`,
      },
      {
        name: `Восстановление`,
        description: `Если пылающий череп уничтожен, он восстанавливает все свои хиты через 1 час, если его останки не сбрызнут святой водой или на них не наложат _Рассеивание магии_ (Dispel magic) или _Снятие проклятья_ (Remove curse)`,
      },
    ],
    spellCast: {
      spellCasterLevel: 5,
    ...
    actionList: [
      {
        name: `Мультиатака`,
        description: `Пылающий череп дважды использует Огненный луч.`,
      },
      {
        name: `Огненный луч`,
        attack: {
