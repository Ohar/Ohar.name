...
Мерфолки защищают свои поселения с копьями, сделанными из таких материалов, которые они могут собрать после кораблекрушений, с пляжей и с мёртвых подводных существ. `,
  ...
  },
  {
    ...
    description: `Микониды — это разумные, прямоходящие грибы, живущие в Подземье, ищущие просветления и порицающие насилие. Если обратиться к ним с миром, микониды с радостью предоставят укрытие и позволят безопасно пройти сквозь свою колонию.\n
