...
Если орк вырывает свой глаз, Груумш может одарить его способностью к заклинаниям и особой благосклонностью, также как и правом называть себя Оком Груумша. Этот дикий поборник бога резни даёт советы вождю предсказаниями, а в бою бросается первым, чтобы обагрить своё оружие кровью. `,
  ...
  },
  {
    ...
    id: CREATURE_OROG,
    description: [
      `Ороги это орки, одарённые удивительным интеллектом, который [обычные орки](CREATURE:orc) считают даром богини Лутик. Как и их богиня, ороги предпочитают жить под землёй, но нехватка пищи часто приводит их на поверхность для охоты. Орки уважают силу и хитрость орогов, и один орог может возглавить военную банду орков.\n
...
Некоторые племена орков специально ищут орогов для усиления своих рядов. Превосходство орогов делает их идеальными лидерами и смертельными противниками для [боевых вождей](CREATURE:orc_war_chief), которые должны опасаться вероломства орогов.\n
