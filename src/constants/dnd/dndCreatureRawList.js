...
**Мастер накопительства.** Золотой дракон копит свои сокровища в хорошо защищённом хранилище глубоко в логове. Волшебная защита, размещающаяся в логове, сделают практически невозможной любую попытку взять что-либо из сокровищ без ведома дракона.`,
    ...
    actionList: [
      ...
      },
      {
        name: 'Оружия дыхания',
        description: `Дракон использует один из следующих видов оружия дыхания.
* **Огненное дыхание.** Дракон выдыхает молнию 90-футовым конусом. Все существа в этой области должны совершить спасбросок Ловкости со Сл 24, получая урон огнём 71 (13к10) при провале, или половину этого урона при успехе.
...
**Мастер накопительства.** Золотой дракон копит свои сокровища в хорошо защищённом хранилище глубоко в логове. Волшебная защита, размещающаяся в логове, сделают практически невозможной любую попытку взять что-либо из сокровищ без ведома дракона.`,
    ...
    actionList: [
      ...
      },
      {
        name: 'Оружия дыхания',
        description: `Дракон использует один из следующих видов оружия дыхания.
* **Огненное дыхание.** Дракон выдыхает молнию 60-футовым конусом. Все существа в этой области должны совершить спасбросок Ловкости со Сл 21, получая урон огнём 66 (12к10) при провале, или половину этого урона при успехе.
...
**Мастер накопительства.** Золотой дракон копит свои сокровища в хорошо защищённом хранилище глубоко в логове. Волшебная защита, размещающаяся в логове, сделают практически невозможной любую попытку взять что-либо из сокровищ без ведома дракона.`,
    ...
    actionList: [
      ...
      },
      {
        name: 'Оружия дыхания',
        description: `Дракон использует один из следующих видов оружия дыхания.
* **Огненное дыхание.** Дракон выдыхает молнию 30-футовым конусом. Все существа в этой области должны совершить спасбросок Ловкости со Сл 17, получая урон огнём 55 (10к10) при провале, или половину этого урона при успехе.
...
**Мастер накопительства.** Золотой дракон копит свои сокровища в хорошо защищённом хранилище глубоко в логове. Волшебная защита, размещающаяся в логове, сделают практически невозможной любую попытку взять что-либо из сокровищ без ведома дракона.`,
    ...
    actionList: [
      ...
      },
      {
        name: 'Оружия дыхания',
        description: `Дракон использует один из следующих видов оружия дыхания.
* **Огненное дыхание.** Дракон выдыхает молнию 15-футовым конусом. Все существа в этой области должны совершить спасбросок Ловкости со Сл 13, получая урон огнём 22 (2к10) при провале, или половину этого урона при успехе.
...
Латунные драконы скрывают свои сокровища под насыпями песка или в тайных закромах вдали от своего основного логова. У них не возникает никаких проблем с запоминанием места, где спрятаны их сокровища, а потому нет никакой необходимости в картах. Искатели приключений и странники должны быть осторожны, если они находят скрытый сундук в оазисе или сокровища, спрятанные в наполовину поглощённых пустыней руинах, ибо это может быть частью клада латунного дракона.`,
    ...
    actionList: [
      ...
      },
      {
        name: 'Оружия дыхания',
        description: `Дракон использует один из следующих видов оружия дыхания.
* **Огненное дыхание.** Дракон выдыхает молнию 90-футовой линией шириной 10 футов. Все существа в этой линии должны совершить спасбросок Ловкости со Сл 21, получая урон огнём 56 (16к6) при провале, или половину этого урона при успехе.
