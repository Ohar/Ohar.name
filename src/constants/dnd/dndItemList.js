...
const dndItemList = [
    {
        ...
        nameEn: '',
        description: 'КД 11 + модификатор Лов. Мешает скрытности. Стёганый доспех состоит из прошитых слоёв ткани и ватина.',
        cost: 500,
        weight: 8,
        source: 'PHB:145',
        category: 'Доспехи',
    ...
    },
    {
        ...
        name: 'Кожаный доспех',
        nameEn: '',
        description: 'КД 11 + модификатор Лов. Нагрудник и плечи этого доспеха изготовлены из кожи, вываренной в масле. Остальные части доспеха сделаны из более мягких и гибких материалов.',
        cost: 1000,
        weight: 10,
        source: 'PHB:145',
        category: 'Доспехи',
    ...
    },
    {
        ...
        nameEn: '',
        description: 'КД 12 + модификатор Лов. Изготовленный из крепкой, но гибкой кожи проклёпанный доспех усилен тесно расположенными шипами или заклёпками.',
        cost: 4500,
        weight: 13,
        source: 'PHB:145',
        category: 'Доспехи',
    ...
    },
    {
        ...
        name: 'Шкурный доспех',
        nameEn: '',
        description: 'КД 12 + модификатор Лов (макс. 2). Этот грубый доспех состоит из толстых мехов и шкур. Обычно их носят племена варваров, злые гуманоиды и прочие народы, у которых нет инструментов и материалов для создания более качественных доспехов.',
        cost: 1000,
        weight: 12,
        source: 'PHB:145',
        category: 'Доспехи',
    ...
    },
    {
        ...
        nameEn: '',
        description: 'КД 13 + модификатор Лов (макс. 2). Сделанная из переплетённых металлических колец кольчужная рубаха носится между слоями одежды или кожи. Этот доспех предоставляет умеренную защиту торса и заглушает звон колец внешним покрытием.',
        cost: 5000,
        weight: 20,
        source: 'PHB:145',
        category: 'Доспехи',
    ...
    },
    {
        ...
        nameEn: '',
        description: 'КД 14 + модификатор Лов (макс. 2). Мешает скрытности. Этот доспех состоит из кожаных куртки и поножей (а также, возможно, отдельной юбки), покрытых перекрывающимися кусочками металла, похожими на рыбную чешую. В комплект входят рукавицы.',
        cost: 5000,
        weight: 45,
        source: 'PHB:145',
        category: 'Доспехи',
    ...
    },
    {
        ...
        name: 'Кираса',
        nameEn: '',
        description: 'КД 14 + модификатор Лов (макс. 2). Этот доспех состоит из подогнанного металлического панциря, носимого с подкладкой из кожи. Несмотря на то, что руки и ноги остаются практически без защиты, этот доспех хорошо защищает жизненно важные органы, оставляя владельцу относительную подвижность.',
        cost: 40000,
        weight: 20,
        source: 'PHB:145',
        category: 'Доспехи',
    ...
    },
    {
        ...
        name: 'Полулаты',
        nameEn: '',
        description: 'КД 15 + модификатор Лов (макс. 2). Мешает скрытности. Полулаты состоят из сформированных металлических пластин, покрывающих большую часть тела владельца. В них не входит защита для ног кроме простых поножей, закреплённых кожаными ремнями.',
        cost: 75000,
        weight: 40,
        source: 'PHB:145',
        category: 'Доспехи',
    ...
    },
    {
        ...
        nameEn: '',
        description: 'КД 14. Мешает скрытности. Это кожаный доспех с нашитыми на него толстыми кольцами. Эти кольца усиливают доспех от ударов мечей и топоров. Колечный доспех хуже кольчуги, и обычно его носят только те, кто не могут позволить себе доспех получше.',
        cost: 3000,
        weight: 40,
        source: 'PHB:145',
        category: 'Доспехи',
    ...
    },
    {
        ...
        name: 'Кольчуга',
        nameEn: '',
        description: 'КД 16; требует Сил 13. Мешает скрытности. Изготовленная из переплетающихся металлических колец кольчуга включает также слой стёганой ткани, надеваемой под низ, дабы предотвратить натирание и смягчать удары. В комплект входят рукавицы.',
        cost: 7500,
        weight: 55,
        source: 'PHB:145',
        category: 'Доспехи',
    ...
    },
    {
        ...
        nameEn: '',
        description: 'КД 17; требует Сил 15. Мешает скрытности. Этот доспех состоит из узких вертикальных металлических пластин, приклёпанных к кожаной подложке, носимой поверх слоя ватина. Соединения защищаются кольчужным полотном.',
        cost: 20000,
        weight: 60,
        source: 'PHB:145',
        category: 'Доспехи',
    ...
    },
    {
        ...
        name: 'Латы',
        nameEn: '',
        description: 'КД 18. Требует Сил 15. Мешает скрытности. Латы состоят из сформированных металлических пластин, покрывающих всё тело. В комплект лат входят рукавицы, тяжёлые кожаные сапоги, шлем с забралом, и толстый слой ватина. Ремешки и пряжки распределяют вес по всему телу.',
        cost: 150000,
        weight: 65,
        source: 'PHB:145',
        category: 'Доспехи',
