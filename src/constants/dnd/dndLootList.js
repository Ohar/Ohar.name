...
const dndLootList = [
  ...
  },
  {
    ...
    description: `в которой, судя по звукам, {находится жидкость|находится песок|находятся пауки|находится битое стекло}`,
    source: {
      id: 'PHB',
      page: 161,
    },
  ...
  },
  {
    ...
    isDumbItem: true,
    isOnlyLargeCreatureItem: false,
    name: `Крохотный металлический {краб|паук}, который двигается, когда на него не смотрят`,
    description: ``,
    source: {
      id: 'PHB',
      page: 161,
