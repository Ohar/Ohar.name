...
export default [
        ...
        <ul>
          ...
          <li>
            ...
            <ul>
              ...
              <li>Взови по имени к одному из Тех, Кто Живёт Внизу, взмоли его вмешаться и стань его Рабом.</li>
            </ul>
          </li>
        </ul>
      </>
  ...
  },
  {
    ...
    text: (
      <>
        <p><strong>Устраивая привал в опасной местности</strong>, ответьте на вопросы Ведущего о своём лагере. Кто-нибудь в группе должен потратить Припасы.</p>
      ...
      <>
        ...
        <ul>
          ...
          <li>
            ...
            <ul>
              <li>Нанеси урон, но это стоит боеприпасов, потрать Припасы (недоступно для <em>Метательного</em> оружия).</li>
  ...
  },
  {
    ...
    text: (
      <>
        <p><strong>Некоторое время переводя дух и заботясь о здоровье</strong>, потрать Припасы и восстанови 1к6 ОЗ (если кто-то заботится о тебе, то кидает кость и тратит Припасы он). Ты не можешь снова исцеляться таким образом до тех пор, пока снова не получишь урон.</p>
        ...
        <ul>
          ...
          <li>На <strong>7–9</strong>&nbsp;— для этого потребуются дополнительные усилия (<DwMoveLink id='common.defy_danger'>Спастись от угрозы</DwMoveLink>, <DwMoveLink id='common.set_camp'>Разбить лагерь</DwMoveLink>) или ресурсы (потратить Припасы, найти _____).</li>
        </ul>
      </>
    ),
  },
