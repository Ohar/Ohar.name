...
export default [
  {
    ...
    text: (
      <>
        ...
        <p>Кроме того, <strong><DwMoveLink id='common.recover'>Восстанавливаясь</DwMoveLink></strong>, если ты находишься под землёй или в горах, ты не тратишь Припасы. </p>
      </>
    ),
  },
  {
    ...
    text: (
      <>
        ...
        <p>Кроме того, когда ты <strong><DwMoveLink id='common.set_camp'>Разбиваешь лагерь</DwMoveLink> и поёшь песни холмового народа</strong>, любой, кто их слышит (включая тебя), восстанавливают дополнительные 1к6 ОЗ.</p>
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    text: (
      <>
        ...
        <ul>
          <li>На <strong>10+</strong>&nbsp;— ты создаёшь, что хотел. Любой, кто осмотрит твоё творение, убедится в его отменном качестве: предмет получает свойство <em>Сделан дварфами</em>. Опиши дополнительную особенность или свойство, которые говорит о том, что это — работа мастера.</li>
          <li>На <strong>7–9</strong>&nbsp;— ты создаёшь, что хотел. Любой, кто осмотрит твоё творение, убедится в его отменном качестве: предмет получает свойство <em>Сделан дварфами</em>.</li>
          <li>На <strong>6−</strong>&nbsp;— ты всё равно создаёшь предмет, но он получился некачественным (по дварфийским стандартам) — он не получает свойство <em>Сделан дварфами</em>.</li>
        </ul>
  ...
  },
  {
    ...
    text: (
      <>
        <p><strong>Ты всегда можешь потратить Припасы, чтобы достать крепкую выпивку</strong>. Больше одного такого крепкого напитка достаточно, чтобы не-дварф напился в&nbsp;стельку.</p>
        <p><strong>Когда ты <DwMoveLink id='common.recover'>Восстанавливаешься</DwMoveLink></strong> и делишься крепкой выпивкой (потрать Припасы), любой, кто её выпьет, восстанавливает дополнительное ОЗ, равное его ТЕЛ (не менее 1).</p>
      </>
    ),
  },
  {
