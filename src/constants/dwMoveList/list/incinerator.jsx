...
export default [
  ...
  },
  {
    ...
    text: (
      <>
        <p><strong>Призывая оружие из чистого пламени</strong>, брось +МДР. Это оружие всегда обладает свойствами <em>Огненное</em>, <em>Рука</em> и <em>Опасное</em>. Оно существует, пока не будет погашено.</p>
        <ul>
