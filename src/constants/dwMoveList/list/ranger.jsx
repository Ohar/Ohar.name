...
export default [
  ...
  },
  {
    ...
    text: (
      <>
        ...
        <p><strong><DwMoveLink id='common.recover'>Восстанавливаясь</DwMoveLink> в окружении природы</strong>, тебе не нужно тратить Припасы&nbsp;— опиши, что ты используешь вместо них.</p>
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    text: (
      <>
        ...
        <p><strong>Когда ты должен потратить Припасы ради боеприпасов </strong>(например, <DwMoveLink id='common.volley'>Давая залп</DwMoveLink>), ты можешь решить их не тратить.</p>
  ...
  },
  {
    ...
    text: (
      <>
        <p><strong><DwMoveLink id='common.volley'>Давая залп</DwMoveLink> с оружием без свойства <em>Перезарядка</em></strong>, ты можешь сделать сразу несколько выстрелов. Для этого потрать Припасы и выбери одно: </p>
        <ul>
  ...
  },
  {
    ...
    text: (
      <>
        <p><strong>Выбирая и подготавливая место ночёвки или отдыха группы,</strong> не трать Припасы.</p>
        <p><strong>Тратя время на подготовку места</strong> (поляны, этажа здания, переулка и т. п.), ты можешь потратить Припасы и получить 1 <em>Предосторожности</em>. Если ты хорошо знаешь это место и его опасности, вместо этого получи 2 <em>Предосторожности</em>.</p>
