...
export default [
  ...
  },
  {
    ...
    text: (
      <>
        ...
        <p>Кроме того, <strong>тратя Припасы и демонстрируя неопасный <em>Мелкий</em> предмет</strong>, опиши, как и кого ты убил таким предметом в прошлом и получи преимущество на атаку или запугивание с его помощью.</p>
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    text: (
      <>
        <p><strong>Выполняя ритуал жертвоприношения чтобы получить совет от духов своих предков</strong> (тотемов, богов, и т. п.), потрать Припасы и брось +МДР.</p>
        <ul>
