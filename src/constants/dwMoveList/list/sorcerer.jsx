...
export default [
  ...
  },
  {
    ...
    text: (
      <>
        ...
        <p><strong>Некоторое время работая в безопасном месте над волшебным предметом</strong>, ты можешь потратить Припасы, чтобы усилить его эффекты на одно следующее использование; Ведущий скажет — как именно.</p>
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    name: 'Книжный червь',
    text: (
      <p><strong><DwMoveLink id='common.spout_lore'>Копаясь в памяти</DwMoveLink></strong>, ты можешь потратить Припасы, чтобы достать книгу, свиток или другой источник знания. <strong>Некоторое время изучая то, что ты достал</strong>, ты можешь считать 6− как 7–9, а 7–9 как 10+.</p>
    ),
  },
  {
