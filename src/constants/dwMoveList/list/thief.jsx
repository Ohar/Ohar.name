...
export default [
  ...
  },
  {
    ...
    text: (
      <p><strong>Если ты прячешь на себе <DwTag id='subtle'>Мелкий</DwTag> предмет</strong>, то его нельзя найти. Его можно найти только если ты сам захочешь, чтобы его нашли. Так можно спрятать количество предметов, равное твоей ЛОВ (минимум 1).</p>
    ),
  },
  {
  ...
  },
  {
    ...
    text: (
      <>
        <p><strong>Любой нож или кинжал в твоих руках</strong> имеет свойство <DwTag id='thrown'>Метательное</DwTag>.</p>
        <p>Когда ты <strong>тянешься в скрытые ножны за оружием</strong>, там оказывается нож, метательный нож, сюрикен или подобное <DwTag id='subtle'>Мелкое</DwTag> оружие. После этого ты не можешь вытащить таким образом ещё одно такое оружие, пока у тебя не появится <strong>свободное время в поселении</strong>. </p>
        <p>Ты можешь пользоваться этой способностью, даже если тебя полностью обыскали, или как-то иначе было установлено, что у тебя больше нет скрытых ножен.</p>
      </>
    ),
  },
  {
