...
export default [
  {
    ...
    text: (
      <>
        ...
        <p><strong><DwMoveLink id='common.discern_realities'>Изучая обстановку</DwMoveLink></strong>, ты можешь бросать +ИНТ вместо +МУД и добавить <em>«Какую возможность здесь больше никто не видит?»</em> в список доступных вопросов.</p>
      </>
    ),
  },
  {
    ...
    text: (
      <>
        ...
        <p><strong>Имея достаточно времени</strong>, ты можешь потратить использование Припасов, чтобы сделать маскировку. Твоя внешность может обмануть, но действия легко тебя выдадут, так что веди себя соответствующе.</p>
  ...
  },
  {
    ...
    text: (
      <>
        <p>Ты провёл значительную часть своей жизни, далеко путешествуя и живя своим умом. Почему? Какими поступками ты хвастаетесь, а о каких сожалеете?</p>
        ...
        <ul>
          <li>На <strong>10+</strong>&nbsp;— эта личность может помочь. Расскажи — почему она готова это сделать?</li>
          <li>На <strong>7–9</strong>&nbsp;— эта личность может помочь, но выбери одну возможную проблему.</li>
          <li>На <strong>6−</strong>&nbsp;— Ведущий выбирает одну возможную проблему и может выбрать ещё.</li>
        </ul>
  ...
  },
  {
    ...
    text: (
      <>
        ...
        <ul>
          <li>На <strong>10+</strong>&nbsp;— задай Ведущему оба вопроса об опасности и получи преимущество на следующий ход, действуя на основе ответа.</li>
          <li>На <strong>7–9</strong>&nbsp;— то же самое, но задай только один вопрос об опасности.</li>
    ...
    text: (
      <>
        ...
        <ul>
          ...
          <li>На <strong>7–9</strong>&nbsp;— нанеси урон и выбери одно.</li>
        </ul>
        <p>Варианты</p>
        <ul>
  ...
  },
  {
    ...
    text: (
      <>
        ...
        <ul>
          <li>На <strong>10+</strong>&nbsp;— ты попадаешь туда, но выбери одно осложнение.</li>
          <li>На <strong>7–9</strong>&nbsp;— ты попадаешь туда, но выбери два осложнения.</li>
        </ul>
        <p>Осложнения</p>
        <ul>
          ...
          <li>Ты тратишь 1к3 использований Припасов. Опиши — чего именно?</li>
        </ul>
      </>
    ),
  },
  ...
  },
  {
    ...
    text: (
      <>
        <p>Ты знаешь, где и как достать особые инструменты для воровских дел. <strong>Копаясь в <em>Припасах</em>, чтобы найти особую стрелу или болт</strong>, потрать одно использование Припасов и достань оттуда…</p>
        <ul>
    ...
    text: (
      <>
        ...
        <ul>
          ...
          <li>На <strong>7–9</strong>&nbsp;— ты можешь остаться или сбежать, но если ты сбегаешь, то Ведущий скажет — что (или кого) ты оставили позади или захватил с собой.</li>
        </ul>
      </>
    ),
  },
