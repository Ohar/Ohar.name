...
export default [
  ...
  },
  {
    ...
    text: (
      <>
        <p><strong>Когда твои ОЗ в битве падает до 0</strong>, ты можешь продолжать сражаться. Каждый раз, когда ты получаешь урон, имея 0 ОЗ, получи 1 <em>Увечье</em> (максимум 5). Если тебя что-то исцеляет, пока ты продолжаешь сражаться, вместо этого потеряй 1 <em>Увечье</em>.</p>
