...
module.exports = {
  ...
  <ul>
      ...
      <li>Дварфийской кольчугой (2 брони, <em>Сделана дварфами</em>, вес 2)</li>
      <li>Набор инструментов твоего ремесла (<em>Сделаны дварфами</em>, вес 1)</li>
  </ul>
  <p><strong>Выбери оружие</strong></p>
  <ul>
      <li>Отличный позолоченный и гравированный топор (<em>Взмах меча</em>, <em>Сделан дварфами</em>, вес 1).</li>
      <li>Тяжёлый боевой молот со штампом сделавшего его мастера (<em>Взмах меча</em>, <em>Сделан дварфами</em>, вес 1).</li>
      <li>Простая кирка. Без прикрас, но дело делает (<em>Взмах меча</em>, <em>Сделана дварфами</em>, вес 1).</li>
  </ul>
  <p><strong>Выбери одно:</strong></p>
  <ul>
      <li>Дварфийский арбалет (<em>Близко</em>, +1 урона, перезарядка, <em>Сделан дварфами</em>, вес 1).</li>
      <li>Дварфийский щит (+1 брони, <em>Сделан дварфами</em>, вес 2).</li>
      <li>Горстка полудрагоценных камней (<em>Мелкая</em>, стоимостью около 10 золотых).</li>
  </ul>
  `,
  advancedMoveIdList: [
