...
export default [
  ...
  },
  {
    id: 'messy',
    title: 'Месиво',
    text: (<p>Эффект или оружие с <em>Месивом</em> наносит жуткие раны, буквально разрывая жертв на куски.</p>),
  },
  {
    id: 'forceful',
    title: 'Мощное',
    text: (<p><em>Мощный</em> эффект или оружие может отбросить жертву или даже сбить её с ног.</p>),
  },
  {
    id: 'inconvenient',
    title: 'Неудобное',
    text: (<p>Этот предмет неудобно или сложно использовать.</p>),
  },
  {
    id: 'two_handed',
    title: 'Двуручное',
    text: (<p>Для эффективного использования этой вещи нужны обе руки.</p>),
  },
  {
    id: 'trauma',
    title: 'Травма',
  ...
  },
  {
    ...
    text: (<p>Мелкие предметы пренебрежительно малы и почти ничего не весят.</p>),
  },
  {
    id: 'advantage',
    title: 'Преимущество',
    text: (<p>Вместо 2к6 бросай 3к6 и выбирай два лучших.</p>),
  },
  {
    id: 'disadvantage',
    title: 'Помеха',
    text: (<p>Вместо 2к6 бросай 3к6 и выбирай два худших.</p>),
  },
  {
    id: 'reckless',
    title: 'Безрассудно',
  ...
  },
  {
    ...
    text: (
      <>
        <p><em>Припасы</em> — некое количество простых полезных предметов, которые компетентные приключенцы догадались бы взять с собой туда, куда они отправились. Ты можешь заявить потратить <em>Припасы</em> и достать оттуда еду, питьё, бинты, боеприпасы, и подобные предметы.</p>
