      ...
      <ul>
        <li>
          <p><b>Без точки на конце</b> пишутся единицы
            измерения: <i>млн</i>, <i>млрд</i>, <i>ч</i>, <i>мин</i>, <i>с</i>,
            <i>т</i>, <i>кг</i>, <i>г</i>, <i>м</i>, <i>дм</i>, <i>см</i>, <i>км</i>, <i>мм</i>, <i>мкм</i>, <i>мк</i>,
            <i>нм</i>, <i>В</i>, <i>Гц</i>, <i>Ом</i>, <i>Вт</i>, <i>Дж</i>, <i>Кл</i>, <i>Па</i>, <i>А</i>, <i>Н</i>,
            <i>Ст</i>, <i>атм</i>, <i>бар</i>, <i>бр</i>, <i>тс</i>, <i>кгс</i>, <i>пк</i> (если на них не заканчивается
            предложение)</p>
          <table>
            <tr>
              <th>Правильно</th>
        ...
        <li>
          <p><b>Промежуток значений</b> пишется через тире без отбивки, сокращения <i>г.</i>, <i>в.</i> и некоторые
            другие
            удваиваются для легкости мысленного прочтения. С отрицательными числами употребляется многоточие. Для
        ...
        <li>
          <p>Два <b>числа</b> в цифровой форме не должны стоять рядом. Числа длиннее 4 знаков разбиваются группами по
            три,
            круглые большие числа в тексте лучше писать прописью. <b>Дробная часть</b> не отбивается. У десятичных
            дробей дробная часть отделяется от целой запятой (а не точкой) и отбивается по три знака. Слова <i>часть</i>,
            <i>доля</i> после дроби не пишутся.</p>
          <table>
            <tr>
              <th>Правильно</th>
              <th>Неправильно</th>
